...
LinkedIn        = 2024-04 글로벌 채용 단면    → 글로벌 단면 스냅샷

핵심 비교 ① [담론 vs 현실]   국내 간극   → RQ4 (기술스택 간극 + 담론 프레임)
핵심 비교 ② [국내 vs 글로벌]  수용 격차   → RQ5 (단면-단면 24개월 시차)
```
...
> **LinkedIn 데이터셋명은 '2023-24'지만 listed_time 분포 확인 시 거의 전부 2024-04 단면**. original_listed_time이 2023-12 ~ 2024-04 범위라 시계열 분석은 4개월에 한정 → 본 연구는 단면-단면 비교만 사용. RQ5는 한국 2026-05 vs 글로벌 2024-04 (~24개월 시차)로 명시.
